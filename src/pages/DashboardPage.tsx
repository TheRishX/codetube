...
import { VideoItem, VideoProgress, Playlist, CATEGORIES, AppLayoutPreferences, CategoryInfo } from '../types';
...
export const DashboardPage: React.FC<DashboardPageProps> = ({
  ...
  const lastWatchedVideoId = lastPlayedVideos.length > 0 ? lastPlayedVideos[0].id : null;
